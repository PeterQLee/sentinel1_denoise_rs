...
four ways\: a command line interface, a Python interface, a Rust interface, and a C interface.
...
file. For brevity, only the python interface will be discussed in detail, because functions to the C
and rust interface are nearly identical.
